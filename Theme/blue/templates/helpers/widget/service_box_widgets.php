...
class My_Widget extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            'Service Box',   // Name
            array(
                'description' => 'This box represent butifull fontawasom icon with easy tipoc and some description'
            )
        );
    ...
    public function widget( $args, $instance ) {
        ...
        echo '<div class="service-box-wrap">';

        echo $args['before_widget'];
        
        // font awasom icon wrapper
        ...
        // content wapper
        echo '<div class="service-cnt-wrap">';
    ...
    public function form( $instance ) {
        ...
        <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'icon' ) ); ?>"><?php echo esc_html__( 'Icon:', 'text_domain' ); ?></label>
        ...
        <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'topic' ) ); ?>"><?php echo esc_html__( 'Topic:', 'text_domain' ); ?></label>
